const CloudABISConstant = require('./CloudABISConstant');

const CloudABISResponseParser = {
    GetResponseMessage: function(operationResult)
    {
        let detailsMessage = "";
...
module.exports = { CloudABISResponseParser };